...
#Aman: Currently using local host to serve files
softwareurl = "http://127.0.0.1:80/"
...
#Aman: Using Lai's public/private key pair
softwareupdatepublickey = {'e':65537, 'n':}
...
def do_rsync(serverpath, destdir, tempdir):
  ...
  for line in file(tempdir+"metainfo"):
    ...
    #print 'Should Download?', shoulddownloadfile
